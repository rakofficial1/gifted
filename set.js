...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~2vhX0biA#wFvOa0PA71nuLdGXMg5ZeCHRjb3oMfipVdlDzsoYsCA", // Add sess Id here especially when deploying on panels else use app.json and .env file...
